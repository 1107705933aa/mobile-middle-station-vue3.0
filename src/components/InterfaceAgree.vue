<template>
  <div id="interface-agree">
          ...
          <el-row>
            ...
            <el-col :span="7">
              <el-form-item class="clear-space" label="协议名称">
                <input-box :giveValue="form.agreementName"></input-box>
              </el-form-item>
            </el-col>
            <el-col :span="7">
    ...
    >
      <el-table-column prop="agreementNum" label="协议编号" width="180" align="center"></el-table-column>
